...
public class WorkerProviderTest {
    ...
    public void query_withLimit() {
        provider.query(
                ProjectContract.getStreamUri()
                        .buildUpon()
                        .appendQueryParameter(WorkerContract.QUERY_PARAMETER_LIMIT, "1")
                        .build(),
                ProjectContract.getColumns(),
                "",
                new String[]{},
    ...
    public void query_withLimitAndOffset() {
        provider.query(
                ProjectContract.getStreamUri()
                        .buildUpon()
                        .appendQueryParameter(WorkerContract.QUERY_PARAMETER_OFFSET, "10")
                        .appendQueryParameter(WorkerContract.QUERY_PARAMETER_LIMIT, "5")
                        .build(),
                ProjectContract.getColumns(),
                "",
                new String[]{},

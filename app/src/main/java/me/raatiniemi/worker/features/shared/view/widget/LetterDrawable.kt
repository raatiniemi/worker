...
package me.raatiniemi.worker.features.shared.view.widget
...
class LetterDrawable private constructor(private val text: String) : ShapeDrawable() {
    ...
    companion object {
        ...
        fun build(text: String) = LetterDrawable(text)
    }
}
